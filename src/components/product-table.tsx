  ...
  return (
    <div className="bg-background p-6 space-y-4">
      ...
      <Table>
        <TableCaption>
          {members.length
            ? 'A list of your Slack members.'
            : 'Click “Get Members” to load data.'}
        </TableCaption>

        <TableHeader>
          <TableRow className="h-12">
            <TableHead className="px-4 font-semibold">Member ID</TableHead>
            <TableHead className="px-4 font-semibold">Full Name</TableHead>
            <TableHead className="px-4 font-semibold">Display Name</TableHead>
            <TableHead className="px-4 font-semibold">Email</TableHead>
            <TableHead className="px-4 font-semibold">Account Type</TableHead>
            <TableHead className="px-4 font-semibold">Department</TableHead>
            <TableHead className="px-4 font-semibold">Title</TableHead>
            <TableHead className="px-4 font-semibold">Reporting Manager</TableHead>
            <TableHead className="px-4 font-semibold">City</TableHead>
            <TableHead className="px-4 font-semibold">State</TableHead>
            <TableHead className="px-4 font-semibold text-right">
              Last Updated
            </TableHead>
          </TableRow>
        </TableHeader>
